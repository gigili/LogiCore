...
public class FollowPlayerGoal extends Goal {
    ...
    public void tick() {
        ...
        double targetX = owner.getX() - (owner.getLookAngle().x * 2);
        double targetZ = owner.getZ() - (owner.getLookAngle().z * 2);
        double targetY = owner.getY() + 2.5; // Above head
