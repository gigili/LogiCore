...
public class DatacenterPortModule {
    ...
    public static final DeferredBlock<DatacenterPortBlock> DATACENTER_PORT = BLOCKS.registerBlock(
            "datacenter_port", DatacenterPortBlock::new,
            props -> props.mapColor(MapColor.METAL).strength(3.0F, 3.0F).requiresCorrectToolForDrops());

    public static final DeferredHolder<Item, BlockItem> DATACENTER_PORT_ITEM = ITEMS.registerItem("datacenter_port", props -> new BlockItem(DATACENTER_PORT.get(), props));
