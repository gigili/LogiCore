...
public class ResearchStationMenu extends AbstractContainerMenu {
    ...
    public ResearchStationMenu(int containerId, Inventory playerInventory, BlockEntity entity, ContainerData data) {
        super(ResearchStationModule.RESEARCH_STATION_MENU.get(), containerId);
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.getItemHandler(), 0, 107, 82));
    ...
    public boolean stillValid(@NotNull Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ResearchStationModule.RESEARCH_STATION.get());
    }
